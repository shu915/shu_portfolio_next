...
const SERVICE_ITEMS = [
  ...
  {
    title: "WEBシステム開発",
    imageSrc: "/front-page-works-service-item3.svg",
...
export async function WorksSection() {
  ...
  return (
    <section
      className="py-20 relative bg-center bg-cover bg-no-repeat max-[900px]:bg-scroll bg-fixed bg-[url('/bg-front.webp')]"
    ...
    >
      <div className="max-w-[1232px] mx-auto px-8 md:px-6 max-md:px-4">
        ...
        <h2
          ...
          className="section-title mx-auto text-[2.25rem] font-bold font-(family-name:--font-cormorant) tracking-[0.15em]"
        >
          Works
        </h2>
        ...
        <h3 className="flex w-60 bg-white rounded-4xl border border-primary items-center justify-center mx-auto px-0 py-2 mt-13.5 gap-[0.2rem] text-[1.375rem] font-bold tracking-widest">
          <figure className="w-8 h-8">
            <Image
              src="/front-page-works-sub-title.svg"
              alt="制作実績"
              width={32}
              height={32}
        ...
        <div className="mt-6 flex justify-end">
          <div className="mt-2">
            <Link href="/works" className="arrow-button">
              All Works
            </Link>
